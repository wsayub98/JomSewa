<?php 
	...
	if(isset($update))
	{
		...
		$query="update user set name='$n',mobile='$mob',gender='$gen',services='$hob',dob='$dob' where email='".$_SESSION['user']."'";
	...
	<form method="post">
		<table class="table table-bordered">
			...
			<tr>
				...
				<Td>
					<?php 
					$arrr=explode(",",$res['services']);
					?>
					Social Media <input value="social" <?php if(in_array("Social Media",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					Newspaper/Print <input value="newspaper" <?php if(in_array("Newspaper/Print",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
				</td>
			</tr>
			<tr>
