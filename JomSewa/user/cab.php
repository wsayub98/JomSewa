  ...
  <body>
	...
	<form name="myForm" action="form.php" method="post">
		<center>
			...
			Enter Destination : <select name="destination">
									<option>Gambang(UMP)-Kuantan</option>
									<option>Gambang(UMP)-Pekan(UMP)</option>
									<option>Gambang(UMP)-Teluk Cempedak</option>
								</select><br><br>
			Driver : 
			<?php
$con = mysqli_connect("localhost", "root") or die(mysqli_connect_error());
			...
			$sql="SELECT DriverName FROM driver where DriverServices ='cab'";
